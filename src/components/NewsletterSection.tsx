          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="mt-8 flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
                ...
                />
                <button type="submit" className="inline-flex items-center justify-center gap-2 bg-accent text-accent-foreground font-body text-sm px-8 py-4 rounded-full hover:brightness-110 transition-all duration-300 font-medium shadow-lg shadow-accent/20">
            ...
            <p className="font-body text-xs text-muted-foreground/60 mt-4">
              Useful updates only. Unsubscribe anytime. No spam, ever.
            </p>
          </div>
        </ScrollReveal>
      </div>
